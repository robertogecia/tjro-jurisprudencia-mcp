...
| A pesquisa dá erro dizendo que o portal devolveu uma **"resposta corrompida"** | Mesma situação, de outra forma (visto em 24/09/2026): o site do TJRO responde com um cabeçalho inválido às consultas da extensão, e o programa recusa a resposta. Não é a sua internet nem excesso de pesquisas; esperar não resolve. Veja ["Se a busca parar de funcionar"](#se-a-busca-parar-de-funcionar). |
